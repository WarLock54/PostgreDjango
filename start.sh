...
echo -e "${BLUE}════════════════════════════════════════════${NC}"
echo ""
echo -e "${YELLOW}📋 n8n Workflow Import:${NC}"
echo "  1. http://localhost:5678 → admin / n8n_secure_2026"
echo "  2. Settings → Credentials → Slack, GitHub, Jira, Anthropic ekle"
echo "  3. Workflows → Import from File → n8n-workflows/ klasöründeki JSON'ları sırayla import et"
echo "  4. Her workflow'u Activate et"
echo ""
